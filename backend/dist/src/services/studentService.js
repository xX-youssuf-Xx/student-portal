...
class StudentService {
    ...
    async createStudent(studentData) {
        try {
            ...
            const studentGroup = studentData.grade === "3MIDDLE"
                ? null
                : (studentData.student_group ?? null);
            const result = await database.query("INSERT INTO students (name, phone_number, parent_phone, grade, student_group, password) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *", [
                studentData.name,
