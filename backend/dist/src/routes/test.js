...
import testController, { handleArrayUpload, upload, } from "../controllers/testController";
...
router.patch("/submissions/:id/override-grade", authenticateToken, requireAdmin, testController.overrideGrade);
router.post("/submissions/:id/regrade-physical", authenticateToken, requireAdmin, testController.regradePhysicalSubmission);
