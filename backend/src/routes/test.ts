...
router.get(
	"/tests/:id/submissions/rank",
	authenticateToken,
	testController.getStudentRank,
);
...
router.patch(
	"/tests/:id/view-permission",
	authenticateToken,
	requireAdmin,
	testController.updateViewPermission,
);
router.patch(
	"/tests/:id/show-grade-outside",
	authenticateToken,
	requireAdmin,
	testController.updateShowGradeOutside,
);
router.get(
...
router.get(
	"/tests/:id/submissions/:submissionId",
	authenticateToken,
	requireAdmin,
	testController.getSubmissionWithTest,
);
router.patch(
	"/submissions/:id/manual-grades",
	authenticateToken,
	requireAdmin,
	testController.setManualGrades,
);
...
router.delete(
	...
	authenticateToken,
	requireAdmin,
	testController.deleteTestImage,
);
...
router.get(
	"/tests/:id/eligible-students",
	authenticateToken,
	requireAdmin,
	testController.getEligibleStudents,
);
router.post(
	"/tests/:id/include-students",
	authenticateToken,
	requireAdmin,
	testController.includeStudents,
);

// Admin: export combined rankings for selected tests
router.post(
	"/tests/export-rankings",
	authenticateToken,
	requireAdmin,
	testController.exportRankings,
);
...
router.post(
	"/tests/:id/regrade-all",
	authenticateToken,
	requireAdmin,
	testController.regradeAllSubmissions,
);
...
router.get(
	"/test-history",
	authenticateToken,
	testController.getStudentTestHistory,
);
...
router.get(
	"/tests/:id/images",
	authenticateToken,
	testController.getTestImages,
);
router.post(
	"/tests/:id/upload-bubble-sheet",
	authenticateToken,
	upload.single("bubbleSheet"),
	testController.uploadBubbleSheet,
);
